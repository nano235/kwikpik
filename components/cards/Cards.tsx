...
const cardsData: Card[] = [
	{
		...
		text: "Never miss a due date again. Set your electricity, data, or streaming bills to auto-pay, and Kwikpik handles it for you every time.",
		image: "/images/auto-bills.png",
	},
	{
		title: "Stable Money, Always",
		text: "Hold and move value in USDT, USDC, or DAI without worrying about currency swings. Stablecoins keep your money steady.",
